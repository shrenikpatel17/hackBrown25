...
const scriptResponseSchema = z.object({
  promptArray: z.array(z.string()).length(3),  // Enforces an array of exactly 3 strings
});
...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        },
        {
          ...
          generate 3 of these independent scenarios with the same characters and keep language VERY simple for little kids. 
    ...
    // Split the generated script into individual descriptions and ensure it's an array of 3 strings
